...
class TC: 
    ...
    def  fillupCVC(self):
        ...
        if bot.page_source == log:
            print("No Seat Available! CVC") 
            time.sleep(600)
            transfer.fillupCVC()                                   
        else:
            bot.get('http://api.greenweb.com.bd/api.php?token=3f0eae289407f8909d89e7624a4062d1&to=01647434617,01627129715&message=Transfer+has+started+dude+CVC')         
            time.sleep(600)
            transfer.fillupCVC()   
              
transfer = TC('1611229780', 'Science', '105822')
transfer.fillupCVC()